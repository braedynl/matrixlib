...
class OrderingMatrix(GenericMatrix[SupportsComparisonT]):
    ...
    def __lt__(self: Self, other: GenericMatrix) -> GenericMatrix: ...
    def __gt__(self: Self, other: GenericMatrix) -> GenericMatrix: ...
    def __le__(self: Self, other: GenericMatrix) -> GenericMatrix: ...
    def __ge__(self: Self, other: GenericMatrix) -> GenericMatrix: ...
