...
class Matrix(Sequence[T]):
    ...
    def equal(self: Self, other: MatrixLike[Any]) -> bool: ...
    def reshape(self: Self, nrows: int, ncols: int) -> Self: ...
    def slices(self: Self, *, by: int = Rule.ROW) -> Iterator[Self]: ...
    def mask(self: Self, selector: MatrixLike[Any], null: T) -> Self: ...
    def replace(self: Self, old: T, new: T, *, times: Optional[int] = None) -> Self: ...
    def swap(self: Self, key1: SupportsIndex, key2: SupportsIndex, *, by: int = Rule.ROW) -> Self: ...
    def flip(self: Self, *, by: int = Rule.ROW) -> Self: ...
    def flatten(self: Self, *, by: int = Rule.ROW) -> Self: ...
    def transpose(self: Self) -> Self: ...
    def stack(self: Self, other: MatrixLike[T], *, by: int = Rule.ROW) -> Self: ...
    def pull(self: Self, key: SupportsIndex = -1, *, by: int = Rule.ROW) -> Self: ...
...
class ComplexMatrix(Matrix[ComplexLikeT]):
    ...
    @overload
    def __rmatmul__(self: Self, other: ComplexMatrixLike[Any]) -> ComplexMatrix[Any]: ...
    @overload
    def __rmatmul__(self: Self, other: MatrixLike[Any]) -> Matrix[Any]: ...
...
class RealMatrix(Matrix[RealLikeT]):
    ...
    @overload
    def __lt__(self: Self, other: Union[RealMatrixLike[Any], RealLike]) -> IntegralMatrix[Any]: ...
    @overload
    def __lt__(self: Self, other: Union[MatrixLike[Any], Any]) -> IntegralMatrix[Any]: ...
    @overload
    def __le__(self: RealMatrix[float], other: Union[RealMatrixLike[float], float]) -> IntegralMatrix[bool]: ...
    @overload
    def __le__(self: Self, other: Union[RealMatrixLike[Any], RealLike]) -> IntegralMatrix[Any]: ...
    @overload
    def __le__(self: Self, other: Union[MatrixLike[Any], Any]) -> IntegralMatrix[Any]: ...
    @overload
    def __gt__(self: RealMatrix[float], other: Union[RealMatrixLike[float], float]) -> IntegralMatrix[bool]: ...
    @overload
    def __gt__(self: Self, other: Union[RealMatrixLike[Any], RealLike]) -> IntegralMatrix[Any]: ...
    @overload
    def __gt__(self: Self, other: Union[MatrixLike[Any], Any]) -> IntegralMatrix[Any]: ...
    @overload
    def __ge__(self: RealMatrix[float], other: Union[RealMatrixLike[float], float]) -> IntegralMatrix[bool]: ...
    @overload
    def __ge__(self: Self, other: Union[RealMatrixLike[Any], RealLike]) -> IntegralMatrix[Any]: ...
    @overload
    def __ge__(self: Self, other: Union[MatrixLike[Any], Any]) -> IntegralMatrix[Any]: ...
    ...
    def __matmul__(self: Self, other: MatrixLike[Any]) -> Matrix[Any]: ...
    @overload
    def __rmatmul__(self: RealMatrix[float], other: RealMatrixLike[float]) -> RealMatrix[float]: ...  # type: ignore[misc]
    @overload
    def __rmatmul__(self: Self, other: RealMatrixLike[Any]) -> RealMatrix[Any]: ...  # type: ignore[misc]
    @overload
    def __rmatmul__(self: RealMatrix[float], other: ComplexMatrixLike[complex]) -> ComplexMatrix[complex]: ...
    @overload
    def __rmatmul__(self: Self, other: ComplexMatrixLike[Any]) -> ComplexMatrix[Any]: ...
    @overload
    def __rmatmul__(self: Self, other: MatrixLike[Any]) -> Matrix[Any]: ...
...
class IntegralMatrix(Matrix[IntegralLikeT]):
    ...
    @overload
    def __lt__(self: IntegralMatrix[int], other: Union[RealMatrixLike[float], float]) -> IntegralMatrix[bool]: ...
    @overload
    def __lt__(self: Self, other: Union[RealMatrixLike[Any], RealLike]) -> IntegralMatrix[Any]: ...
    @overload
    def __lt__(self: Self, other: Union[MatrixLike[Any], Any]) -> IntegralMatrix[Any]: ...
    @overload
    def __le__(self: IntegralMatrix[int], other: Union[RealMatrixLike[float], float]) -> IntegralMatrix[bool]: ...
    @overload
    def __le__(self: Self, other: Union[RealMatrixLike[Any], RealLike]) -> IntegralMatrix[Any]: ...
    @overload
    def __le__(self: Self, other: Union[MatrixLike[Any], Any]) -> IntegralMatrix[Any]: ...
    @overload
    def __gt__(self: IntegralMatrix[int], other: Union[RealMatrixLike[float], float]) -> IntegralMatrix[bool]: ...
    @overload
    def __gt__(self: Self, other: Union[RealMatrixLike[Any], RealLike]) -> IntegralMatrix[Any]: ...
    @overload
    def __gt__(self: Self, other: Union[MatrixLike[Any], Any]) -> IntegralMatrix[Any]: ...
    @overload
    def __ge__(self: IntegralMatrix[int], other: Union[RealMatrixLike[float], float]) -> IntegralMatrix[bool]: ...
    @overload
    def __ge__(self: Self, other: Union[RealMatrixLike[Any], RealLike]) -> IntegralMatrix[Any]: ...
    @overload
    def __ge__(self: Self, other: Union[MatrixLike[Any], Any]) -> IntegralMatrix[Any]: ...
    ...
    def __matmul__(self: Self, other: MatrixLike[Any]) -> Matrix[Any]: ...
    @overload
    def __rmatmul__(self: IntegralMatrix[int], other: IntegralMatrixLike[int]) -> IntegralMatrix[int]: ...  # type: ignore[misc]
    @overload
    def __rmatmul__(self: Self, other: IntegralMatrixLike[Any]) -> IntegralMatrix[Any]: ...  # type: ignore[misc]
    @overload
    def __rmatmul__(self: IntegralMatrix[int], other: RealMatrixLike[float]) -> RealMatrix[float]: ...  # type: ignore[misc]
    @overload
    def __rmatmul__(self: Self, other: RealMatrixLike[Any]) -> RealMatrix[Any]: ...  # type: ignore[misc]
    @overload
    def __rmatmul__(self: IntegralMatrix[int], other: ComplexMatrixLike[complex]) -> ComplexMatrix[complex]: ...
    @overload
    def __rmatmul__(self: Self, other: ComplexMatrixLike[Any]) -> ComplexMatrix[Any]: ...
    @overload
    def __rmatmul__(self: Self, other: MatrixLike[Any]) -> Matrix[Any]: ...
