...
class MatrixLike(Protocol[T_co]):
    ...
    @abstractmethod
    @overload
    def __getitem__(self: Self, key: slice) -> MatrixLike[T_co]: ...
    @abstractmethod
    @overload
    def __getitem__(self: Self, key: tuple[int, int]) -> T_co: ...
    @abstractmethod
    @overload
    def __getitem__(self: Self, key: tuple[int, slice]) -> MatrixLike[T_co]: ...
    @abstractmethod
    @overload
    def __getitem__(self: Self, key: tuple[slice, int]) -> MatrixLike[T_co]: ...
    @abstractmethod
    @overload
    def __getitem__(self: Self, key: tuple[slice, slice]) -> MatrixLike[T_co]: ...
    ...
    def equal(self: Self, other: MatrixLike) -> bool: ...
