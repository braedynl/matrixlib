...
class Matrix(FrozenMatrix[T, M, N]):
    ...
    @overload
    def stack(self, other: MatrixLike[T, Any, N], *, by: Literal[Rule.ROW]) -> Matrix[T, Any, N]: ...  # type: ignore[misc]
    @overload
    def stack(self, other: MatrixLike[T, M, Any], *, by: Literal[Rule.COL]) -> Matrix[T, M, Any]: ...  # type: ignore[misc]
    @overload
