...
@overload
def truediv(a: MatrixLike[SupportsTrueDiv[S, T], M, N], b: MatrixLike[S, M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def truediv(a: MatrixLike[S, M, N], b: MatrixLike[SupportsRTrueDiv[S, T], M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def floordiv(a: MatrixLike[SupportsFloorDiv[S, T], M, N], b: MatrixLike[S, M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def floordiv(a: MatrixLike[S, M, N], b: MatrixLike[SupportsRFloorDiv[S, T], M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def mod(a: MatrixLike[SupportsMod[S, T], M, N], b: MatrixLike[S, M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def mod(a: MatrixLike[S, M, N], b: MatrixLike[SupportsRMod[S, T], M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def divmod(a: MatrixLike[SupportsDivMod[S, T], M, N], b: MatrixLike[S, M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def divmod(a: MatrixLike[S, M, N], b: MatrixLike[SupportsRDivMod[S, T], M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def lshift(a: MatrixLike[SupportsLShift[S, T], M, N], b: MatrixLike[S, M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def lshift(a: MatrixLike[S, M, N], b: MatrixLike[SupportsRLShift[S, T], M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def rshift(a: MatrixLike[SupportsRShift[S, T], M, N], b: MatrixLike[S, M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def rshift(a: MatrixLike[S, M, N], b: MatrixLike[SupportsRRShift[S, T], M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def bitwise_and(a: MatrixLike[SupportsAnd[S, T], M, N], b: MatrixLike[S, M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def bitwise_and(a: MatrixLike[S, M, N], b: MatrixLike[SupportsRAdd[S, T], M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def bitwise_xor(a: MatrixLike[SupportsXor[S, T], M, N], b: MatrixLike[S, M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def bitwise_xor(a: MatrixLike[S, M, N], b: MatrixLike[SupportsRXor[S, T], M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def bitwise_or(a: MatrixLike[SupportsOr[S, T], M, N], b: MatrixLike[S, M, N], /) -> MatrixMap[T, M, N]: ...
@overload
def bitwise_or(a: MatrixLike[S, M, N], b: MatrixLike[SupportsROr[S, T], M, N], /) -> MatrixMap[T, M, N]: ...
