...
class MatrixView(MatrixViewLike[T_co, M_co, N_co]):
    ...
    @overload
    def equal(self, other: MatrixLike[Any, M_co, N_co]) -> IntegerMatrixLike[M_co, N_co]: ...
    @overload
    def equal(self, other: Any) -> IntegerMatrixLike[M_co, N_co]: ...

    def equal(self, other):
        return self.target.equal(other)

    @overload
    def not_equal(self, other: MatrixLike[Any, M_co, N_co]) -> IntegerMatrixLike[M_co, N_co]: ...
    @overload
    def not_equal(self, other: Any) -> IntegerMatrixLike[M_co, N_co]: ...
...
class IntegralMatrixView(IntegerMatrixLike[M_co, N_co], MatrixView[int, M_co, N_co]):
