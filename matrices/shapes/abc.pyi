...
class ShapeLike(Collection[Union[M_co, N_co]], Generic[M_co, N_co], metaclass=ABCMeta):
    ...
    def __lt__(self, other: Union[ShapeLike[int, int], tuple[int, int]]) -> bool: ...
    def __le__(self, other: Union[ShapeLike[int, int], tuple[int, int]]) -> bool: ...
    def __eq__(self, other: Any) -> bool: ...
    def __ne__(self, other: Any) -> bool: ...
    def __gt__(self, other: Union[ShapeLike[int, int], tuple[int, int]]) -> bool: ...
    def __ge__(self, other: Union[ShapeLike[int, int], tuple[int, int]]) -> bool: ...
    ...
    def compare(self, other: Union[ShapeLike[int, int], tuple[int, int]]) -> Literal[-1, 0, 1]: ...
