...
class SupportsClosedAdd(Protocol):
    def __add__(self: SupportsClosedAddT, other: SupportsClosedAddT) -> SupportsClosedAddT: ...

SupportsClosedAddT_co = TypeVar("SupportsClosedAddT_co", bound=SupportsClosedAdd, covariant=True)

class SupportsDotProduct(Protocol[T_contra, SupportsClosedAddT_co]):
    def __mul__(self, other: T_contra) -> SupportsClosedAddT_co: ...
class SupportsRDotProduct(Protocol[T_contra, SupportsClosedAddT_co]):
    def __rmul__(self, other: T_contra) -> SupportsClosedAddT_co: ...
