...
class MatrixLike(Sequence[T_co], Generic[T_co, NRows_co, NCols_co], metaclass=ABCMeta):
    ...
    @abstractmethod
    def lt(self, other: MatrixLike[T_co, NRows_co, NCols_co]) -> MatrixLike[bool, NRows_co, NCols_co]: ...
    @abstractmethod
    def le(self, other: MatrixLike[T_co, NRows_co, NCols_co]) -> MatrixLike[bool, NRows_co, NCols_co]: ...
    @abstractmethod
    def gt(self, other: MatrixLike[T_co, NRows_co, NCols_co]) -> MatrixLike[bool, NRows_co, NCols_co]: ...
    @abstractmethod
    def ge(self, other: MatrixLike[T_co, NRows_co, NCols_co]) -> MatrixLike[bool, NRows_co, NCols_co]: ...
    @abstractmethod
