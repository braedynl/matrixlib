...
class MatrixLike(Sequence[T_co], Generic[T_co, M_co, N_co], metaclass=ABCMeta):
    ...
    def __lt__(self, other: MatrixLike[T_co, int, int]) -> bool: ...
    def __le__(self, other: MatrixLike[T_co, int, int]) -> bool: ...
    def __eq__(self, other: Any) -> bool: ...
    def __ne__(self, other: Any) -> bool: ...
    def __gt__(self, other: MatrixLike[T_co, int, int]) -> bool: ...
    def __ge__(self, other: MatrixLike[T_co, int, int]) -> bool: ...
    ...
    @overload
    def slices(self, *, by: Rule, reverse: bool = False) -> Iterator[MatrixLike[T_co, int, int]]: ...
    @overload
